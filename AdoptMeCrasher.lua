...
task.spawn(function()
    ...
    Create("TextLabel",{Font = Enum.Font.Nunito,Text = "Expected time to crash: 120-200 seconds",TextColor3 = Color3.new(0.466667, 0.360784, 1),TextSize = 45,TextStrokeTransparency = 0,AnchorPoint = Vector2.new(0.5, 0.1),BackgroundColor3 = Color3.new(1, 1, 1),BackgroundTransparency = 1,Position = UDim2.new(0.5, 0, 0.1, 0),Size = UDim2.new(0.200000003, 0, 0, 0),Visible = true,Parent = UI})
